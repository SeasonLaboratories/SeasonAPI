package store.seasonlabs.api.libraries.text.type;
...
import store.seasonlabs.api.libraries.text.type.util.ReflectionUtils;
...
public final class ActionBarMessage {
    ...
    public static void sendActionBar(@Nonnull Player player, @Nullable String message) {
        ...
        val colored = ColorLibrary.colored(message);
        if (SPIGOT_OFFICIAL_SUPPORT) {
